...
### 1. 构造数据集
# 读取数据集和json
data_path = './datav1_feature15.xlsx'
...
save_json('./data/goods_train.json', x_data[:800]+y_data[:800])
save_json('./data/goods_valid.json', x_data[800:900]+y_data[800:900])
save_json('./data/goods_test.json', x_data[9:]+y_data[9:])